...
def _elp(
    *,
    ...
    return EvidenceLandscapePackage.from_research_state(
        ...
        coverage_summary={
            "requirements_covered": ["REQ-001"] if revised else [],
            "requirements_partially_covered": [] if revised else ["REQ-001"],
            "requirements_uncovered": [],
            "routes_executed": ["ER-101"],
            "routes_underexplored": [] if revised else ["ER-101"],
            "routes_exhausted": [],
